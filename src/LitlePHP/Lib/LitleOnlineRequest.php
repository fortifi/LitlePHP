...
class LitleOnlineRequest
{
  ...
  public function __construct($treeResponse = false)
  {
    ...
    Obj2xml::$config = new LitleConfig();
  }
  ...
  public function overrideConfigValue($name, $value)
  {
    Obj2xml::$config->$name = $value;
  }
    ...
    else
    {
      $hash_out = [
        'orderId'                  => Checker::requiredField(
          XmlFields::returnArrayValue($hash_in, 'orderId')
        ),
        'amount'                   => Checker::requiredField(
          XmlFields::returnArrayValue($hash_in, 'amount')
        ),
        'surchargeAmount'          => XmlFields::returnArrayValue(
          $hash_in,
          'surchargeAmount'
        ),
        'orderSource'              => Checker::requiredField(
          XmlFields::returnArrayValue($hash_in, 'orderSource')
        ),
        'customerInfo'             => (XmlFields::customerInfo(
          XmlFields::returnArrayValue($hash_in, 'customerInfo')
        )),
        'billToAddress'            => (XmlFields::contact(
          XmlFields::returnArrayValue($hash_in, 'billToAddress')
        )),
        'shipToAddress'            => (XmlFields::contact(
          XmlFields::returnArrayValue($hash_in, 'shipToAddress')
        )),
        'card'                     => (XmlFields::cardType(
          XmlFields::returnArrayValue($hash_in, 'card')
        )),
        'paypal'                   => (XmlFields::payPal(
          XmlFields::returnArrayValue($hash_in, 'paypal')
        )),
        'token'                    => (XmlFields::cardTokenType(
          XmlFields::returnArrayValue($hash_in, 'token')
        )),
        'paypage'                  => (XmlFields::cardPaypageType(
          XmlFields::returnArrayValue($hash_in, 'paypage')
        )),
        'mpos'                     => (XmlFields::mposType(
          XmlFields::returnArrayValue($hash_in, 'mpos')
        )),
        'billMeLaterRequest'       => (XmlFields::billMeLaterRequest(
          XmlFields::returnArrayValue($hash_in, 'billMeLaterRequest')
        )),
        'cardholderAuthentication' => (XmlFields::fraudCheckType(
          XmlFields::returnArrayValue($hash_in, 'cardholderAuthentication')
        )),
        'processingInstructions'   => (XmlFields::processingInstructions(
          XmlFields::returnArrayValue($hash_in, 'processingInstructions')
        )),
        'pos'                      => (XmlFields::pos(
          XmlFields::returnArrayValue($hash_in, 'pos')
        )),
        'customBilling'            => (XmlFields::customBilling(
          XmlFields::returnArrayValue($hash_in, 'customBilling')
        )),
        'taxBilling'               => (XmlFields::taxBilling(
          XmlFields::returnArrayValue($hash_in, 'taxBilling')
        )),
        'enhancedData'             => (XmlFields::enhancedData(
          XmlFields::returnArrayValue($hash_in, 'enhancedData')
        )),
        'amexAggregatorData'       => (XmlFields::amexAggregatorData(
          XmlFields::returnArrayValue($hash_in, 'amexAggregatorData')
        )),
        'allowPartialAuth'         => XmlFields::returnArrayValue(
          $hash_in,
          'allowPartialAuth'
        ),
        'healthcareIIAS'           => (XmlFields::healthcareIIAS(
          XmlFields::returnArrayValue($hash_in, 'healthcareIIAS')
        )),
        'filtering'                => (XmlFields::filteringType(
          XmlFields::returnArrayValue($hash_in, 'filtering')
        )),
        'merchantData'             => (XmlFields::merchantData(
          XmlFields::returnArrayValue($hash_in, 'merchantData')
        )),
        'recyclingRequest'         => (XmlFields::recyclingRequestType(
          XmlFields::returnArrayValue($hash_in, 'recyclingRequest')
        )),
        'fraudFilterOverride'      => XmlFields::returnArrayValue(
          $hash_in,
          'fraudFilterOverride'
        ),
        'recurringRequest'         => XmlFields::recurringRequestType(
          XmlFields::returnArrayValue($hash_in, 'recurringRequest')
        ),
        'debtRepayment'            => XmlFields::returnArrayValue(
          $hash_in,
          'debtRepayment'
        ),
        'advancedFraudChecks'      => XmlFields::advancedFraudChecksType(
          XmlFields::returnArrayValue($hash_in, 'advancedFraudChecks')
        ),
      ];
    }
    $choice_hash = [
      ...
      XmlFields::returnArrayValue($hash_out, 'mpos'),
    ];
    $authorizationResponse = $this->processRequest(
      $hash_out,
      $hash_in,
      'authorization',
      $choice_hash
  ...
  public function saleRequest($hash_in)
  {
    $hash_out = [
      ...
      'fraudCheck'                    => XmlFields::fraudCheckType(
        XmlFields::returnArrayValue($hash_in, 'fraudCheck')
      ),
      'cardholderAuthentication'      => XmlFields::fraudCheckType(
        XmlFields::returnArrayValue($hash_in, 'cardholderAuthentication')
      ),
      ...
      'payPalOrderComplete'           => XmlFields::returnArrayValue(
        $hash_in,
        'paypalOrderComplete'
      ),
      ...
      'litleInternalRecurringRequest' => XmlFields::litleInternalRecurringRequestType(
        XmlFields::returnArrayValue($hash_in, 'litleInternalRecurringRequest')
      ),
      'debtRepayment'                 => XmlFields::returnArrayValue(
        $hash_in,
        'debtRepayment'
    ...
    $saleResponse = $this->processRequest(
      $hash_out,
      $hash_in,
      'sale',
      $choice_hash,
  ...
  {
    $hash_out = [
      'litleTxnId'      => Checker::requiredField(
        XmlFields::returnArrayValue($hash_in, 'litleTxnId')
      ),
    ...
    $authReversalResponse = $this->processRequest(
      $hash_out,
      $hash_in,
      'authReversal'
    );
  ...
  public function creditRequest($hash_in)
  {
    $hash_out = [
      ...
      'orderId'                => XmlFields::returnArrayValue(
        $hash_in,
        'orderId'
      ),
      'amount'                 => XmlFields::returnArrayValue(
        $hash_in,
        'amount'
      ),
      'surchargeAmount'        => XmlFields::returnArrayValue(
      ...
      'orderSource'            => XmlFields::returnArrayValue(
        $hash_in,
        'orderSource'
      ),
      'billToAddress'          => XmlFields::contact(
      ...
      'paypal'                 => XmlFields::credit_payPal(
        XMLFields::returnArrayValue($hash_in, 'paypal')
      ),
      'token'                  => XmlFields::cardTokenType(
        XMLFields::returnArrayValue($hash_in, 'token')
    ...
    $creditResponse = $this->processRequest(
      $hash_out,
      $hash_in,
      'credit',
      $choice_hash
  ...
  public function registerTokenRequest($hash_in)
  {
    $hash_out = [
      ...
      'accountNumber'         => XmlFields::returnArrayValue(
        $hash_in,
        'accountNumber'
      ),
      'echeckForToken'        => XmlFields::echeckForTokenType(
        XmlFields::returnArrayValue($hash_in, 'echeckForToken')
      ),
      'paypageRegistrationId' => XmlFields::returnArrayValue(
        $hash_in,
        'paypageRegistrationId'
      ),
      'cardValidationNum'     => XmlFields::returnArrayValue(
        $hash_in,
        'cardValidationNum'
      ),
    ];
    ...
    $registerTokenResponse = $this->processRequest(
      $hash_out,
      $hash_in,
  ...
  public function forceCaptureRequest($hash_in)
  {
    ...
    $forceCaptureResponse = $this->processRequest(
      $hash_out,
      $hash_in,
      'forceCapture',
      $choice_hash
  ...
  {
    $hash_out = [
      'partial'                => XmlFields::returnArrayValue(
        $hash_in,
        'partial'
      ),
      'litleTxnId'             => Checker::requiredField(
  ...
  public function captureGivenAuthRequest($hash_in)
  {
    $hash_out = [
      ...
      'authInformation'        => XmlFields::authInformation(
        XmlFields::returnArrayValue($hash_in, 'authInformation')
      ),
      'amount'                 => Checker::requiredField(
        XmlFields::returnArrayValue($hash_in, 'amount')
      ),
    ...
    $captureGivenAuthResponse = $this->processRequest(
      $hash_out,
      $hash_in,
      'captureGivenAuth',
      $choice_hash
  ...
  public function echeckRedepositRequest($hash_in)
  {
    $hash_out = [
      ...
      'echeck'       => XmlFields::echeckType(
        XmlFields::returnArrayValue($hash_in, 'echeck')
      ),
      'echeckToken'  => XmlFields::echeckTokenType(
        XmlFields::returnArrayValue($hash_in, 'echeckToken')
      ),
      'merchantData' => (XmlFields::merchantData(
        XmlFields::returnArrayValue($hash_in, 'merchantData')
      )),
    ...
    $echeckRedepositResponse = $this->processRequest(
      $hash_out,
      $hash_in,
      'echeckRedeposit',
      $choice_hash
  ...
  public function echeckSaleRequest($hash_in)
  {
    ...
    $echeckSaleResponse = $this->processRequest(
      $hash_out,
      $hash_in,
      'echeckSale',
      $choice_hash
  ...
  public function echeckCreditRequest($hash_in)
  {
    ...
    $choice_hash = [$hash_out['echeck'], $hash_out['echeckToken']];
    $echeckCreditResponse = $this->processRequest(
      $hash_out,
      $hash_in,
      'echeckCredit',
      $choice_hash
  ...
  public function echeckVerificationRequest($hash_in)
  {
    ...
    $choice_hash = [$hash_out['echeck'], $hash_out['echeckToken']];
    $echeckVerificationResponse = $this->processRequest(
      $hash_out,
      $hash_in,
      'echeckVerification',
      $choice_hash
  ...
  public function echeckVoidRequest($hash_in)
  {
    ...
    $echeckVoidResponse = $this->processRequest(
      $hash_out,
      $hash_in,
      "echeckVoid"
    );
  ...
  public function updateCardValidationNumOnToken($hash_in)
  {
    $hash_out = [
      'orderId'           => XmlFields::returnArrayValue($hash_in, 'orderId'),
      'litleToken'        => Checker::requiredField(
        XmlFields::returnArrayValue($hash_in, 'litleToken')
      ),
      'cardValidationNum' => Checker::requiredField(
        XmlFields::returnArrayValue($hash_in, 'cardValidationNum')
      ),
    ];
    $updateCardValidationNumOnTokenResponse = $this->processRequest(
      $hash_out,
      $hash_in,
  ...
  public function updateSubscription($hash_in)
  {
    ...
    $updateSubscriptionResponse = $this->processRequest(
      $hash_out,
      $hash_in,
      "updateSubscription"
    );
  ...
  public function cancelSubscription($hash_in)
  {
    ...
    $cancelSubscriptionResponse = $this->processRequest(
      $hash_out,
      $hash_in,
      "cancelSubscription"
    );
  ...
  public function updatePlan($hash_in)
  {
    ...
    $updatePlanResponse = $this->processRequest(
      $hash_out,
      $hash_in,
      "updatePlan"
    );
  ...
  public function createPlan($hash_in)
  {
    ...
    $createPlanResponse = $this->processRequest(
      $hash_out,
      $hash_in,
      "createPlan"
    );
  ...
  {
    $hash_out = [
      'id'                => Checker::requiredField(
        XmlFields::returnArrayValue($hash_in, 'id')
      ),
      'origId'            => Checker::requiredField(
        XmlFields::returnArrayValue($hash_in, 'origId')
      ),
      'origActionType'    => Checker::requiredField(
        XmlFields::returnArrayValue($hash_in, 'origActionType')
      ),
      'origLitleTxnId'    => XmlFields::returnArrayValue(
        $hash_in,
        'origLitleTxnId'
      ),
      'origOrderId'       => XmlFields::returnArrayValue(
        $hash_in,
        'origOrderId'
      ),
      'origAccountNumber' => XmlFields::returnArrayValue(
        $hash_in,
        'origAccountNumber'
      ),
    ];
    $queryTransactionResponse = $this->processRequest(
      $hash_out,
      $hash_in,
      "queryTransaction"
    );
  ...
  {
    $hash_config = [];
    $names = explode(',', LitleConstants::$LITLE_CONFIG_LIST);
  ...
  private static function getOptionalAttributes($hash_in, $hash_out)
  {
    ...
    {
      $hash_out['merchantSdk'] = XmlFields::returnArrayValue(
        $hash_in,
        'merchantSdk'
      );
    }
    ...
    {
      $hash_out['customerId'] = XmlFields::returnArrayValue(
        $hash_in,
        'customerId'
      );
    }
    ...
    {
      $hash_out['loggedInUser'] = XmlFields::returnArrayValue(
        $hash_in,
        'loggedInUser'
      );
    }
  ...
  private function processRequest(
    $hash_out, $hash_in, $type, $choice1 = null, $choice2 = null
  )
  {
    ...
    $litleOnlineResponse = $this->newXML->request(
      $request,
      $hash_config,
      $this->useSimpleXml
    );
